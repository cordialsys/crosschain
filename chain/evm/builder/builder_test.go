...
func TestStakingTxUsesCredential(t *testing.T) {
	...
	args, _ := xcbuilder.NewStakeArgs(xc.ETH, owner, xcbuilder.OptionStakeAmount(1))
...
func TestUnstakingTx(t *testing.T) {
	...
	args, _ := xcbuilder.NewStakeArgs(xc.ETH, owner, xcbuilder.OptionStakeAmount(human.ToBlockchain(18).Uint64()))
