...
func (obj *Argument__Input) Serialize(serializer serde.Serializer) error {
	...
	serializer.SerializeVariantIndex(1)
	if err := serializer.SerializeU16(((uint16)(*obj))); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func load_Argument__Input(deserializer serde.Deserializer) (Argument__Input, error) {
	var obj uint16
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (Argument__Input)(obj), err
	}
...
func load_Argument__Result(deserializer serde.Deserializer) (Argument__Result, error) {
	var obj uint16
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (Argument__Result)(obj), err
	}
	if val, err := deserializer.DeserializeU16(); err == nil {
		obj = val
	} else {
...
func (obj *Argument__NestedResult) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeU16(obj.Field1); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeAuthorityPublicKeyBytes(deserializer serde.Deserializer) (AuthorityPublicKeyBytes, error) {
	var obj []byte
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (AuthorityPublicKeyBytes)(obj), err
	}
...
func load_CallArg__Object(deserializer serde.Deserializer) (CallArg__Object, error) {
	...
	if val, err := DeserializeObjectArg(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func (obj *ChangeEpoch) Serialize(serializer serde.Serializer) error {
	...
	if err := obj.ProtocolVersion.Serialize(serializer); err != nil {
		return err
	}
	if err := serializer.SerializeU64(obj.StorageCharge); err != nil {
		return err
	}
	if err := serializer.SerializeU64(obj.ComputationCharge); err != nil {
		return err
	}
	if err := serializer.SerializeU64(obj.StorageRebate); err != nil {
		return err
	}
	if err := serializer.SerializeU64(obj.NonRefundableStorageFee); err != nil {
		return err
	}
	if err := serializer.SerializeU64(obj.EpochStartTimestampMs); err != nil {
		return err
	}
	if err := serialize_vector_tuple3_SequenceNumber_vector_vector_u8_vector_ObjectID(obj.SystemPackages, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeChangeEpoch(deserializer serde.Deserializer) (ChangeEpoch, error) {
	...
	if val, err := DeserializeProtocolVersion(deserializer); err == nil {
		obj.ProtocolVersion = val
	} else {
		return obj, err
	}
	if val, err := deserializer.DeserializeU64(); err == nil {
		obj.StorageCharge = val
	} else {
		return obj, err
	}
	if val, err := deserializer.DeserializeU64(); err == nil {
		obj.ComputationCharge = val
	} else {
		return obj, err
	}
	if val, err := deserializer.DeserializeU64(); err == nil {
		obj.StorageRebate = val
	} else {
		return obj, err
	}
	if val, err := deserializer.DeserializeU64(); err == nil {
		obj.NonRefundableStorageFee = val
	} else {
		return obj, err
	}
	if val, err := deserializer.DeserializeU64(); err == nil {
		obj.EpochStartTimestampMs = val
	} else {
		return obj, err
	}
	if val, err := deserialize_vector_tuple3_SequenceNumber_vector_vector_u8_vector_ObjectID(deserializer); err == nil {
		obj.SystemPackages = val
	} else {
		return obj, err
	}
	deserializer.DecreaseContainerDepth()
...
func load_CheckpointCommitment__EcmhLiveObjectSetDigest(deserializer serde.Deserializer) (CheckpointCommitment__EcmhLiveObjectSetDigest, error) {
	...
	if val, err := DeserializeECMHLiveObjectSetDigest(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func load_CheckpointContents__V1(deserializer serde.Deserializer) (CheckpointContents__V1, error) {
	...
	if val, err := DeserializeCheckpointContentsV1(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func DeserializeCheckpointContentsDigest(deserializer serde.Deserializer) (CheckpointContentsDigest, error) {
	...
	if val, err := DeserializeDigest(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func (obj *CheckpointContentsV1) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_ExecutionDigests(obj.Transactions, serializer); err != nil {
		return err
	}
	if err := serialize_vector_vector_GenericSignature(obj.UserSignatures, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeCheckpointContentsV1(deserializer serde.Deserializer) (CheckpointContentsV1, error) {
	...
	if val, err := deserialize_vector_ExecutionDigests(deserializer); err == nil {
		obj.Transactions = val
	} else {
		return obj, err
	}
	if val, err := deserialize_vector_vector_GenericSignature(deserializer); err == nil {
		obj.UserSignatures = val
	} else {
		return obj, err
	}
	deserializer.DecreaseContainerDepth()
...
func (obj *CheckpointSummary) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeU64(obj.NetworkTotalTransactions); err != nil {
		return err
	}
	if err := obj.ContentDigest.Serialize(serializer); err != nil {
		return err
	}
	if err := serialize_option_CheckpointDigest(obj.PreviousDigest, serializer); err != nil {
		return err
	}
	if err := obj.EpochRollingGasCostSummary.Serialize(serializer); err != nil {
		return err
	}
	if err := serializer.SerializeU64(obj.TimestampMs); err != nil {
		return err
	}
	if err := serialize_vector_CheckpointCommitment(obj.CheckpointCommitments, serializer); err != nil {
		return err
	}
	if err := serialize_option_EndOfEpochData(obj.EndOfEpochData, serializer); err != nil {
		return err
	}
	if err := serialize_vector_u8(obj.VersionSpecificData, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeCheckpointSummary(deserializer serde.Deserializer) (CheckpointSummary, error) {
	...
	if val, err := deserializer.DeserializeU64(); err == nil {
		obj.NetworkTotalTransactions = val
	} else {
		return obj, err
	}
	if val, err := DeserializeCheckpointContentsDigest(deserializer); err == nil {
		obj.ContentDigest = val
	} else {
		return obj, err
	}
	if val, err := deserialize_option_CheckpointDigest(deserializer); err == nil {
		obj.PreviousDigest = val
	} else {
		return obj, err
	}
	if val, err := DeserializeGasCostSummary(deserializer); err == nil {
		obj.EpochRollingGasCostSummary = val
	} else {
		return obj, err
	}
	if val, err := deserializer.DeserializeU64(); err == nil {
	...
	if val, err := deserialize_vector_CheckpointCommitment(deserializer); err == nil {
		obj.CheckpointCommitments = val
	} else {
		return obj, err
	}
	if val, err := deserialize_option_EndOfEpochData(deserializer); err == nil {
		obj.EndOfEpochData = val
	} else {
		return obj, err
	}
	if val, err := deserialize_vector_u8(deserializer); err == nil {
		obj.VersionSpecificData = val
	} else {
		return obj, err
	}
	deserializer.DecreaseContainerDepth()
...
func load_Command__MoveCall(deserializer serde.Deserializer) (Command__MoveCall, error) {
	...
	if val, err := DeserializeProgrammableMoveCall(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func (obj *Command__TransferObjects) Serialize(serializer serde.Serializer) error {
	...
	serializer.SerializeVariantIndex(1)
	if err := serialize_vector_Argument(obj.Field0, serializer); err != nil {
		return err
	}
...
func load_Command__TransferObjects(deserializer serde.Deserializer) (Command__TransferObjects, error) {
	...
	if val, err := deserialize_vector_Argument(deserializer); err == nil {
		obj.Field0 = val
	} else {
		return obj, err
	}
	if val, err := DeserializeArgument(deserializer); err == nil {
		obj.Field1 = val
	} else {
		return obj, err
	}
...
func (obj *Command__SplitCoins) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_Argument(obj.Field1, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func (obj *Command__Publish) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_vector_u8(obj.Field0, serializer); err != nil {
		return err
	}
	if err := serialize_vector_ObjectID(obj.Field1, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func load_Command__Publish(deserializer serde.Deserializer) (Command__Publish, error) {
	...
	if val, err := deserialize_vector_vector_u8(deserializer); err == nil {
		obj.Field0 = val
	} else {
		return obj, err
	}
	if val, err := deserialize_vector_ObjectID(deserializer); err == nil {
		obj.Field1 = val
	} else {
		return obj, err
	}
...
func (obj *Command__MakeMoveVec) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_option_TypeTag(obj.Field0, serializer); err != nil {
		return err
	}
	if err := serialize_vector_Argument(obj.Field1, serializer); err != nil {
		return err
...
func load_Command__MakeMoveVec(deserializer serde.Deserializer) (Command__MakeMoveVec, error) {
	...
	if val, err := deserialize_option_TypeTag(deserializer); err == nil {
		obj.Field0 = val
	} else {
		return obj, err
	}
...
func (obj *Command__Upgrade) Serialize(serializer serde.Serializer) error {
	...
	if err := obj.Field2.Serialize(serializer); err != nil {
		return err
	}
	if err := obj.Field3.Serialize(serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func load_Command__Upgrade(deserializer serde.Deserializer) (Command__Upgrade, error) {
	...
	if val, err := DeserializeObjectID(deserializer); err == nil {
		obj.Field2 = val
	} else {
		return obj, err
	}
...
func (obj *CommandArgumentError__IndexOutOfBounds) Serialize(serializer serde.Serializer) error {
	...
	serializer.SerializeVariantIndex(4)
	if err := serializer.SerializeU16(obj.Idx); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func (obj *CommandArgumentError__SecondaryIndexOutOfBounds) Serialize(serializer serde.Serializer) error {
	...
	serializer.SerializeVariantIndex(5)
	if err := serializer.SerializeU16(obj.ResultIdx); err != nil {
		return err
	}
	if err := serializer.SerializeU16(obj.SecondaryIdx); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func load_CompressedSignature__Ed25519(deserializer serde.Deserializer) (CompressedSignature__Ed25519, error) {
	var obj [64]uint8
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (CompressedSignature__Ed25519)(obj), err
	}
...
func load_CompressedSignature__Secp256k1(deserializer serde.Deserializer) (CompressedSignature__Secp256k1, error) {
	var obj [64]uint8
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (CompressedSignature__Secp256k1)(obj), err
	}
	if val, err := deserialize_array64_u8_array(deserializer); err == nil {
		obj = val
	} else {
...
func (obj *ConsensusCommitPrologue) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeU64(obj.CommitTimestampMs); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func load_Data__Move(deserializer serde.Deserializer) (Data__Move, error) {
	...
	if val, err := DeserializeMoveObject(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func load_Data__Package(deserializer serde.Deserializer) (Data__Package, error) {
	...
	if val, err := DeserializeMovePackage(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func (obj *ECMHLiveObjectSetDigest) Serialize(serializer serde.Serializer) error {
	...
	if err := obj.Digest.Serialize(serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func (obj *EndOfEpochData) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_tuple2_AuthorityPublicKeyBytes_u64(obj.NextEpochCommittee, serializer); err != nil {
		return err
	}
	if err := obj.NextEpochProtocolVersion.Serialize(serializer); err != nil {
		return err
	}
	if err := serialize_vector_CheckpointCommitment(obj.EpochCommitments, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeEndOfEpochData(deserializer serde.Deserializer) (EndOfEpochData, error) {
	...
	if val, err := deserialize_vector_tuple2_AuthorityPublicKeyBytes_u64(deserializer); err == nil {
		obj.NextEpochCommittee = val
	} else {
		return obj, err
	}
	if val, err := DeserializeProtocolVersion(deserializer); err == nil {
		obj.NextEpochProtocolVersion = val
	} else {
		return obj, err
	}
	if val, err := deserialize_vector_CheckpointCommitment(deserializer); err == nil {
		obj.EpochCommitments = val
	} else {
		return obj, err
	}
	deserializer.DecreaseContainerDepth()
...
func (obj *Envelope) Serialize(serializer serde.Serializer) error {
	...
	if err := obj.AuthSignature.Serialize(serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeEnvelope(deserializer serde.Deserializer) (Envelope, error) {
	...
	if val, err := DeserializeSenderSignedData(deserializer); err == nil {
		obj.Data = val
	} else {
		return obj, err
	}
	if val, err := DeserializeEmptySignInfo(deserializer); err == nil {
		obj.AuthSignature = val
	} else {
		return obj, err
	}
	deserializer.DecreaseContainerDepth()
...
func (obj *ExecutionData) Serialize(serializer serde.Serializer) error {
	...
	if err := obj.Effects.Serialize(serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeExecutionData(deserializer serde.Deserializer) (ExecutionData, error) {
	...
	if val, err := DeserializeEnvelope(deserializer); err == nil {
		obj.Transaction = val
	} else {
		return obj, err
	}
	if val, err := DeserializeTransactionEffects(deserializer); err == nil {
		obj.Effects = val
	} else {
		return obj, err
	}
...
func DeserializeExecutionDigests(deserializer serde.Deserializer) (ExecutionDigests, error) {
	...
	if val, err := DeserializeTransactionDigest(deserializer); err == nil {
		obj.Transaction = val
	} else {
		return obj, err
	}
	if val, err := DeserializeTransactionEffectsDigest(deserializer); err == nil {
		obj.Effects = val
	} else {
		return obj, err
	}
...
func (obj *ExecutionFailureStatus__MoveObjectTooBig) Serialize(serializer serde.Serializer) error {
	...
	serializer.SerializeVariantIndex(4)
	if err := serializer.SerializeU64(obj.ObjectSize); err != nil {
		return err
	}
	if err := serializer.SerializeU64(obj.MaxObjectSize); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func (obj *ExecutionFailureStatus__CircularObjectOwnership) Serialize(serializer serde.Serializer) error {
	...
	serializer.SerializeVariantIndex(6)
	if err := obj.Object.Serialize(serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func load_ExecutionFailureStatus__MovePrimitiveRuntimeError(deserializer serde.Deserializer) (ExecutionFailureStatus__MovePrimitiveRuntimeError, error) {
	...
	if val, err := DeserializeMoveLocationOpt(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func load_ExecutionFailureStatus__MoveAbort(deserializer serde.Deserializer) (ExecutionFailureStatus__MoveAbort, error) {
	...
	if val, err := DeserializeMoveLocation(deserializer); err == nil {
		obj.Field0 = val
	} else {
		return obj, err
	}
...
func (obj *ExecutionFailureStatus__CommandArgumentError) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeU16(obj.ArgIdx); err != nil {
		return err
	}
...
func load_ExecutionFailureStatus__CommandArgumentError(deserializer serde.Deserializer) (ExecutionFailureStatus__CommandArgumentError, error) {
	...
	if val, err := DeserializeCommandArgumentError(deserializer); err == nil {
		obj.Kind = val
	} else {
		return obj, err
	}
...
func (obj *ExecutionFailureStatus__TypeArgumentError) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeU16(obj.ArgumentIdx); err != nil {
		return err
	}
	if err := obj.Kind.Serialize(serializer); err != nil {
		return err
...
func load_ExecutionFailureStatus__TypeArgumentError(deserializer serde.Deserializer) (ExecutionFailureStatus__TypeArgumentError, error) {
	...
	if val, err := DeserializeTypeArgumentError(deserializer); err == nil {
		obj.Kind = val
	} else {
		return obj, err
	}
...
func (obj *ExecutionFailureStatus__EffectsTooLarge) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeU64(obj.CurrentSize); err != nil {
		return err
	}
	if err := serializer.SerializeU64(obj.MaxSize); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func (obj *ExecutionFailureStatus__PackageUpgradeError) Serialize(serializer serde.Serializer) error {
	...
	if err := obj.UpgradeError.Serialize(serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func load_ExecutionFailureStatus__PackageUpgradeError(deserializer serde.Deserializer) (ExecutionFailureStatus__PackageUpgradeError, error) {
	...
	if val, err := DeserializePackageUpgradeError(deserializer); err == nil {
		obj.UpgradeError = val
	} else {
		return obj, err
	}
	deserializer.DecreaseContainerDepth()
...
func (obj *ExecutionStatus__Failure) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_option_u64(obj.Command, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func load_ExecutionStatus__Failure(deserializer serde.Deserializer) (ExecutionStatus__Failure, error) {
	...
	if val, err := DeserializeExecutionFailureStatus(deserializer); err == nil {
		obj.Error = val
	} else {
		return obj, err
	}
...
func (obj *FullCheckpointContents) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_ExecutionData(obj.Transactions, serializer); err != nil {
		return err
	}
	if err := serialize_vector_vector_GenericSignature(obj.UserSignatures, serializer); err != nil {
		return err
...
func DeserializeFullCheckpointContents(deserializer serde.Deserializer) (FullCheckpointContents, error) {
	...
	if val, err := deserialize_vector_ExecutionData(deserializer); err == nil {
		obj.Transactions = val
	} else {
		return obj, err
	}
...
func (obj *GasCostSummary) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeU64(obj.ComputationCost); err != nil {
		return err
	}
	if err := serializer.SerializeU64(obj.StorageCost); err != nil {
		return err
	}
	if err := serializer.SerializeU64(obj.StorageRebate); err != nil {
		return err
...
func (obj *GasData) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_tuple3_ObjectID_SequenceNumber_ObjectDigest(obj.Payment, serializer); err != nil {
		return err
	}
	if err := obj.Owner.Serialize(serializer); err != nil {
		return err
	}
	if err := serializer.SerializeU64(obj.Price); err != nil {
		return err
	}
	if err := serializer.SerializeU64(obj.Budget); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeGasData(deserializer serde.Deserializer) (GasData, error) {
	...
	if val, err := deserialize_vector_tuple3_ObjectID_SequenceNumber_ObjectDigest(deserializer); err == nil {
		obj.Payment = val
	} else {
		return obj, err
	}
	if val, err := DeserializeSuiAddress(deserializer); err == nil {
		obj.Owner = val
	} else {
		return obj, err
	}
...
func DeserializeGenericSignature(deserializer serde.Deserializer) (GenericSignature, error) {
	var obj []uint8
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (GenericSignature)(obj), err
	}
	if val, err := deserialize_vector_u8(deserializer); err == nil {
		obj = val
	} else {
...
func load_GenesisObject__RawObject(deserializer serde.Deserializer) (GenesisObject__RawObject, error) {
	...
	if val, err := DeserializeData(deserializer); err == nil {
		obj.Data = val
	} else {
		return obj, err
	}
	if val, err := DeserializeOwner(deserializer); err == nil {
		obj.Owner = val
	} else {
		return obj, err
	}
...
func (obj *GenesisTransaction) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_GenesisObject(obj.Objects, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeGenesisTransaction(deserializer serde.Deserializer) (GenesisTransaction, error) {
	...
	if val, err := deserialize_vector_GenesisObject(deserializer); err == nil {
		obj.Objects = val
	} else {
		return obj, err
	}
...
func (obj *Intent) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeU8(obj.Scope); err != nil {
		return err
	}
	if err := serializer.SerializeU8(obj.Version); err != nil {
		return err
	}
	if err := serializer.SerializeU8(obj.AppId); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func (obj *IntentMessage) Serialize(serializer serde.Serializer) error {
	...
	if err := obj.Intent.Serialize(serializer); err != nil {
		return err
	}
	if err := obj.Value.Serialize(serializer); err != nil {
		return err
...
func DeserializeIntentMessage(deserializer serde.Deserializer) (IntentMessage, error) {
	...
	if val, err := DeserializeIntent(deserializer); err == nil {
		obj.Intent = val
	} else {
		return obj, err
	}
	if val, err := DeserializeTransactionData(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func (obj *MoveFieldLayout) Serialize(serializer serde.Serializer) error {
	...
	if err := obj.Layout.Serialize(serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeMoveFieldLayout(deserializer serde.Deserializer) (MoveFieldLayout, error) {
	...
	if val, err := DeserializeMoveTypeLayout(deserializer); err == nil {
		obj.Layout = val
	} else {
		return obj, err
	}
...
func (obj *MoveLocation) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeU16(obj.Instruction); err != nil {
		return err
	}
	if err := serialize_option_str(obj.FunctionName, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func (obj *MoveLocationOpt) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_option_MoveLocation(obj.Value, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeMoveLocationOpt(deserializer serde.Deserializer) (MoveLocationOpt, error) {
	...
	if val, err := deserialize_option_MoveLocation(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func (obj *MoveObject) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeBool(obj.HasPublicTransfer); err != nil {
		return err
	}
	if err := obj.Version.Serialize(serializer); err != nil {
		return err
	}
	if err := serializer.SerializeBytes(obj.Contents); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeMoveObject(deserializer serde.Deserializer) (MoveObject, error) {
	...
	if val, err := DeserializeMoveObjectType(deserializer); err == nil {
		obj.Type = val
	} else {
		return obj, err
	}
	if val, err := deserializer.DeserializeBool(); err == nil {
		obj.HasPublicTransfer = val
	} else {
		return obj, err
	}
	if val, err := DeserializeSequenceNumber(deserializer); err == nil {
		obj.Version = val
	} else {
		return obj, err
	}
...
func DeserializeMoveObjectType(deserializer serde.Deserializer) (MoveObjectType, error) {
	...
	if val, err := DeserializeMoveObjectType_(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func (obj *MovePackage) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_map_str_to_bytes(obj.ModuleMap, serializer); err != nil {
		return err
	}
	if err := serialize_vector_TypeOrigin(obj.TypeOriginTable, serializer); err != nil {
		return err
	}
	if err := serialize_map_ObjectID_to_UpgradeInfo(obj.LinkageTable, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeMovePackage(deserializer serde.Deserializer) (MovePackage, error) {
	...
	if val, err := deserialize_map_str_to_bytes(deserializer); err == nil {
		obj.ModuleMap = val
	} else {
		return obj, err
	}
	if val, err := deserialize_vector_TypeOrigin(deserializer); err == nil {
		obj.TypeOriginTable = val
	} else {
		return obj, err
	}
	if val, err := deserialize_map_ObjectID_to_UpgradeInfo(deserializer); err == nil {
		obj.LinkageTable = val
	} else {
		return obj, err
	}
	deserializer.DecreaseContainerDepth()
...
func (obj *MoveStructLayout__Runtime) Serialize(serializer serde.Serializer) error {
	...
	serializer.SerializeVariantIndex(0)
	if err := serialize_vector_MoveTypeLayout((([]MoveTypeLayout)(*obj)), serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func load_MoveStructLayout__Runtime(deserializer serde.Deserializer) (MoveStructLayout__Runtime, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (MoveStructLayout__Runtime)(obj), err
	}
	if val, err := deserialize_vector_MoveTypeLayout(deserializer); err == nil {
		obj = val
	} else {
		return ((MoveStructLayout__Runtime)(obj)), err
	}
...
func (obj *MoveStructLayout__WithFields) Serialize(serializer serde.Serializer) error {
	...
	serializer.SerializeVariantIndex(1)
	if err := serialize_vector_MoveFieldLayout((([]MoveFieldLayout)(*obj)), serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func load_MoveStructLayout__WithFields(deserializer serde.Deserializer) (MoveStructLayout__WithFields, error) {
	var obj []MoveFieldLayout
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (MoveStructLayout__WithFields)(obj), err
	}
	if val, err := deserialize_vector_MoveFieldLayout(deserializer); err == nil {
		obj = val
	} else {
		return ((MoveStructLayout__WithFields)(obj)), err
	}
...
func (obj *MoveStructLayout__WithTypes) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_MoveFieldLayout(obj.Fields, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func load_MoveTypeLayout__Struct(deserializer serde.Deserializer) (MoveTypeLayout__Struct, error) {
	...
	if val, err := DeserializeMoveStructLayout(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func (obj *MultiSig) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_CompressedSignature(obj.Sigs, serializer); err != nil {
		return err
	}
	if err := serializer.SerializeBytes(obj.Bitmap); err != nil {
		return err
	}
	if err := obj.MultisigPk.Serialize(serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeMultiSig(deserializer serde.Deserializer) (MultiSig, error) {
	...
	if val, err := deserialize_vector_CompressedSignature(deserializer); err == nil {
		obj.Sigs = val
	} else {
		return obj, err
	}
	...
	if val, err := DeserializeMultiSigPublicKey(deserializer); err == nil {
		obj.MultisigPk = val
	} else {
		return obj, err
	}
...
func (obj *MultiSigPublicKey) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_tuple2_str_u8(obj.PkMap, serializer); err != nil {
		return err
	}
	if err := serializer.SerializeU16(obj.Threshold); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeMultiSigPublicKey(deserializer serde.Deserializer) (MultiSigPublicKey, error) {
	...
	if val, err := deserialize_vector_tuple2_str_u8(deserializer); err == nil {
		obj.PkMap = val
	} else {
		return obj, err
	}
...
func (obj *ObjectArg__ImmOrOwnedObject) Serialize(serializer serde.Serializer) error {
	...
	serializer.SerializeVariantIndex(0)
	if err := serialize_tuple3_ObjectID_SequenceNumber_ObjectDigest(((struct {
		Field0 ObjectID
		Field1 SequenceNumber
		Field2 ObjectDigest
...
func load_ObjectArg__ImmOrOwnedObject(deserializer serde.Deserializer) (ObjectArg__ImmOrOwnedObject, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (ObjectArg__ImmOrOwnedObject)(obj), err
	}
	if val, err := deserialize_tuple3_ObjectID_SequenceNumber_ObjectDigest(deserializer); err == nil {
		obj = val
	} else {
		return ((ObjectArg__ImmOrOwnedObject)(obj)), err
	}
...
func (obj *ObjectArg__SharedObject) Serialize(serializer serde.Serializer) error {
	...
	if err := obj.InitialSharedVersion.Serialize(serializer); err != nil {
		return err
	}
...
func (obj *PackageUpgradeError__UnableToFetchPackage) Serialize(serializer serde.Serializer) error {
	...
	serializer.SerializeVariantIndex(0)
	if err := obj.PackageId.Serialize(serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func (obj *PackageUpgradeError__NotAPackage) Serialize(serializer serde.Serializer) error {
	...
	serializer.SerializeVariantIndex(1)
	if err := obj.ObjectId.Serialize(serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func (obj *PackageUpgradeError__DigestDoesNotMatch) Serialize(serializer serde.Serializer) error {
	...
	serializer.SerializeVariantIndex(3)
	if err := serialize_vector_u8(obj.Digest, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func (obj *PackageUpgradeError__UnknownUpgradePolicy) Serialize(serializer serde.Serializer) error {
	...
	serializer.SerializeVariantIndex(4)
	if err := serializer.SerializeU8(obj.Policy); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func (obj *PackageUpgradeError__PackageIdDoesNotMatch) Serialize(serializer serde.Serializer) error {
	...
	if err := obj.TicketId.Serialize(serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func (obj *ProgrammableMoveCall) Serialize(serializer serde.Serializer) error {
	...
	if err := obj.Package.Serialize(serializer); err != nil {
		return err
	}
	if err := obj.Module.Serialize(serializer); err != nil {
		return err
	...
	if err := serialize_vector_TypeTag(obj.TypeArguments, serializer); err != nil {
		return err
	}
	if err := serialize_vector_Argument(obj.Arguments, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func (obj *ProgrammableTransaction) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_CallArg(obj.Inputs, serializer); err != nil {
		return err
	}
	if err := serialize_vector_Command(obj.Commands, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeProgrammableTransaction(deserializer serde.Deserializer) (ProgrammableTransaction, error) {
	...
	if val, err := deserialize_vector_CallArg(deserializer); err == nil {
		obj.Inputs = val
	} else {
		return obj, err
	}
	if val, err := deserialize_vector_Command(deserializer); err == nil {
		obj.Commands = val
	} else {
		return obj, err
	}
...
func DeserializeProtocolVersion(deserializer serde.Deserializer) (ProtocolVersion, error) {
	var obj uint64
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (ProtocolVersion)(obj), err
	}
	if val, err := deserializer.DeserializeU64(); err == nil {
		obj = val
	} else {
...
func (obj *SenderSignedData) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_SenderSignedTransaction((([]SenderSignedTransaction)(*obj)), serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeSenderSignedData(deserializer serde.Deserializer) (SenderSignedData, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (SenderSignedData)(obj), err
	}
	if val, err := deserialize_vector_SenderSignedTransaction(deserializer); err == nil {
		obj = val
	} else {
		return ((SenderSignedData)(obj)), err
	}
...
func (obj *SenderSignedTransaction) Serialize(serializer serde.Serializer) error {
	...
	if err := obj.IntentMessage.Serialize(serializer); err != nil {
		return err
	}
	if err := serialize_vector_GenericSignature(obj.TxSignatures, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeSenderSignedTransaction(deserializer serde.Deserializer) (SenderSignedTransaction, error) {
	...
	if val, err := DeserializeIntentMessage(deserializer); err == nil {
		obj.IntentMessage = val
	} else {
		return obj, err
	}
	if val, err := deserialize_vector_GenericSignature(deserializer); err == nil {
		obj.TxSignatures = val
	} else {
		return obj, err
	}
	deserializer.DecreaseContainerDepth()
...
func load_TransactionData__V1(deserializer serde.Deserializer) (TransactionData__V1, error) {
	...
	if val, err := DeserializeTransactionDataV1(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func (obj *TransactionDataV1) Serialize(serializer serde.Serializer) error {
	...
	if err := obj.GasData.Serialize(serializer); err != nil {
		return err
	}
	if err := obj.Expiration.Serialize(serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeTransactionDataV1(deserializer serde.Deserializer) (TransactionDataV1, error) {
	...
	if val, err := DeserializeTransactionKind(deserializer); err == nil {
		obj.Kind = val
	} else {
		return obj, err
	}
	...
	if val, err := DeserializeGasData(deserializer); err == nil {
		obj.GasData = val
	} else {
		return obj, err
	}
	if val, err := DeserializeTransactionExpiration(deserializer); err == nil {
		obj.Expiration = val
	} else {
		return obj, err
	}
...
func load_TransactionEffects__V1(deserializer serde.Deserializer) (TransactionEffects__V1, error) {
	...
	if val, err := DeserializeTransactionEffectsV1(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func (obj *TransactionEffectsV1) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeU64(obj.ExecutedEpoch); err != nil {
		return err
	}
	if err := obj.GasUsed.Serialize(serializer); err != nil {
		return err
	}
	if err := serialize_vector_tuple2_ObjectID_SequenceNumber(obj.ModifiedAtVersions, serializer); err != nil {
		return err
	}
	if err := serialize_vector_tuple3_ObjectID_SequenceNumber_ObjectDigest(obj.SharedObjects, serializer); err != nil {
		return err
	}
	if err := obj.TransactionDigest.Serialize(serializer); err != nil {
		return err
	}
	if err := serialize_vector_tuple2_tuple3_ObjectID_SequenceNumber_ObjectDigest_Owner(obj.Created, serializer); err != nil {
		return err
	}
	if err := serialize_vector_tuple2_tuple3_ObjectID_SequenceNumber_ObjectDigest_Owner(obj.Mutated, serializer); err != nil {
		return err
	}
	if err := serialize_vector_tuple2_tuple3_ObjectID_SequenceNumber_ObjectDigest_Owner(obj.Unwrapped, serializer); err != nil {
		return err
	}
	if err := serialize_vector_tuple3_ObjectID_SequenceNumber_ObjectDigest(obj.Deleted, serializer); err != nil {
		return err
	}
	if err := serialize_vector_tuple3_ObjectID_SequenceNumber_ObjectDigest(obj.UnwrappedThenDeleted, serializer); err != nil {
		return err
	}
	if err := serialize_vector_tuple3_ObjectID_SequenceNumber_ObjectDigest(obj.Wrapped, serializer); err != nil {
		return err
	}
	if err := serialize_tuple2_tuple3_ObjectID_SequenceNumber_ObjectDigest_Owner(obj.GasObject, serializer); err != nil {
		return err
	}
	if err := serialize_option_TransactionEventsDigest(obj.EventsDigest, serializer); err != nil {
		return err
	}
	if err := serialize_vector_TransactionDigest(obj.Dependencies, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeTransactionEffectsV1(deserializer serde.Deserializer) (TransactionEffectsV1, error) {
	...
	if val, err := DeserializeExecutionStatus(deserializer); err == nil {
		obj.Status = val
	} else {
		return obj, err
	}
	if val, err := deserializer.DeserializeU64(); err == nil {
		obj.ExecutedEpoch = val
	} else {
		return obj, err
	}
	if val, err := DeserializeGasCostSummary(deserializer); err == nil {
	...
	if val, err := deserialize_vector_tuple2_ObjectID_SequenceNumber(deserializer); err == nil {
		obj.ModifiedAtVersions = val
	} else {
		return obj, err
	}
	if val, err := deserialize_vector_tuple3_ObjectID_SequenceNumber_ObjectDigest(deserializer); err == nil {
		obj.SharedObjects = val
	} else {
		return obj, err
	}
	if val, err := DeserializeTransactionDigest(deserializer); err == nil {
		obj.TransactionDigest = val
	} else {
		return obj, err
	}
	if val, err := deserialize_vector_tuple2_tuple3_ObjectID_SequenceNumber_ObjectDigest_Owner(deserializer); err == nil {
		obj.Created = val
	} else {
		return obj, err
	}
	...
	if val, err := deserialize_tuple2_tuple3_ObjectID_SequenceNumber_ObjectDigest_Owner(deserializer); err == nil {
		obj.GasObject = val
	} else {
		return obj, err
	}
	if val, err := deserialize_option_TransactionEventsDigest(deserializer); err == nil {
		obj.EventsDigest = val
	} else {
		return obj, err
	}
	if val, err := deserialize_vector_TransactionDigest(deserializer); err == nil {
		obj.Dependencies = val
	} else {
		return obj, err
	}
	deserializer.DecreaseContainerDepth()
...
func load_TransactionExpiration__Epoch(deserializer serde.Deserializer) (TransactionExpiration__Epoch, error) {
	var obj uint64
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (TransactionExpiration__Epoch)(obj), err
	}
	if val, err := deserializer.DeserializeU64(); err == nil {
		obj = val
	} else {
...
func load_TransactionKind__ProgrammableTransaction(deserializer serde.Deserializer) (TransactionKind__ProgrammableTransaction, error) {
	...
	if val, err := DeserializeProgrammableTransaction(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func load_TransactionKind__ChangeEpoch(deserializer serde.Deserializer) (TransactionKind__ChangeEpoch, error) {
	...
	if val, err := DeserializeChangeEpoch(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func load_TransactionKind__Genesis(deserializer serde.Deserializer) (TransactionKind__Genesis, error) {
	...
	if val, err := DeserializeGenesisTransaction(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func load_TransactionKind__ConsensusCommitPrologue(deserializer serde.Deserializer) (TransactionKind__ConsensusCommitPrologue, error) {
	...
	if val, err := DeserializeConsensusCommitPrologue(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func (obj *TypeOrigin) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeStr(obj.ModuleName); err != nil {
		return err
	}
	if err := serializer.SerializeStr(obj.StructName); err != nil {
		return err
	}
	if err := obj.Package.Serialize(serializer); err != nil {
		return err
...
func load_TypedStoreError__RocksDbError(deserializer serde.Deserializer) (TypedStoreError__RocksDbError, error) {
	var obj string
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (TypedStoreError__RocksDbError)(obj), err
	}
	if val, err := deserializer.DeserializeStr(); err == nil {
		obj = val
	} else {
...
func load_TypedStoreError__SerializationError(deserializer serde.Deserializer) (TypedStoreError__SerializationError, error) {
	var obj string
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (TypedStoreError__SerializationError)(obj), err
	}
	if val, err := deserializer.DeserializeStr(); err == nil {
		obj = val
	} else {
...
func load_TypedStoreError__UnregisteredColumn(deserializer serde.Deserializer) (TypedStoreError__UnregisteredColumn, error) {
	var obj string
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (TypedStoreError__UnregisteredColumn)(obj), err
	}
	if val, err := deserializer.DeserializeStr(); err == nil {
		obj = val
	} else {
...
func (obj *UpgradeInfo) Serialize(serializer serde.Serializer) error {
	...
	if err := obj.UpgradedId.Serialize(serializer); err != nil {
		return err
	}
	if err := obj.UpgradedVersion.Serialize(serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func deserialize_map_ObjectID_to_UpgradeInfo(deserializer serde.Deserializer) (map[ObjectID]UpgradeInfo, error) {
	...
	previous_slice := serde.Slice{Start: 0, End: 0}
	for i := 0; i < int(length); i++ {
		...
		if val, err := DeserializeUpgradeInfo(deserializer); err == nil {
			obj[key] = val
		} else {
			return nil, err
		}
...
func serialize_map_str_to_bytes(value map[string][]byte, serializer serde.Serializer) error {
	...
	for k, v := range value {
		...
		if err := serializer.SerializeBytes(v); err != nil {
			return err
		}
	}
	serializer.SortMapEntries(offsets)
...
func deserialize_option_CheckpointDigest(deserializer serde.Deserializer) (*CheckpointDigest, error) {
	...
	if tag {
		...
		if val, err := DeserializeCheckpointDigest(deserializer); err == nil {
			*value = val
		} else {
			return nil, err
		}
...
func deserialize_option_EndOfEpochData(deserializer serde.Deserializer) (*EndOfEpochData, error) {
	...
	if tag {
		...
		if val, err := DeserializeEndOfEpochData(deserializer); err == nil {
			*value = val
		} else {
			return nil, err
		}
...
func deserialize_option_TransactionEventsDigest(deserializer serde.Deserializer) (*TransactionEventsDigest, error) {
	...
	if tag {
		...
		if val, err := DeserializeTransactionEventsDigest(deserializer); err == nil {
			*value = val
		} else {
			return nil, err
		}
...
func serialize_tuple2_AuthorityPublicKeyBytes_u64(value struct {
	Field0 AuthorityPublicKeyBytes
	Field1 uint64
	...
	if err := serializer.SerializeU64(value.Field1); err != nil {
		return err
	}
	return nil
}

func deserialize_tuple2_AuthorityPublicKeyBytes_u64(deserializer serde.Deserializer) (struct {
	Field0 AuthorityPublicKeyBytes
	Field1 uint64
}, error) {
	var obj struct {
	...
	if val, err := DeserializeAuthorityPublicKeyBytes(deserializer); err == nil {
		obj.Field0 = val
	} else {
		return obj, err
	}
...
func serialize_tuple2_ObjectID_SequenceNumber(value struct {
	Field0 ObjectID
	Field1 SequenceNumber
}, serializer serde.Serializer) error {
	if err := value.Field0.Serialize(serializer); err != nil {
...
func deserialize_tuple2_ObjectID_SequenceNumber(deserializer serde.Deserializer) (struct {
	Field0 ObjectID
	Field1 SequenceNumber
}, error) {
	var obj struct {
...
func serialize_tuple2_str_u8(value struct {
	Field0 string
	Field1 uint8
}, serializer serde.Serializer) error {
	if err := serializer.SerializeStr(value.Field0); err != nil {
		return err
	}
...
func deserialize_tuple2_str_u8(deserializer serde.Deserializer) (struct {
	Field0 string
	Field1 uint8
}, error) {
	var obj struct {
...
func serialize_tuple2_tuple3_ObjectID_SequenceNumber_ObjectDigest_Owner(value struct {
	Field0 struct {
		Field0 ObjectID
		Field1 SequenceNumber
		Field2 ObjectDigest
	...
	if err := serialize_tuple3_ObjectID_SequenceNumber_ObjectDigest(value.Field0, serializer); err != nil {
		return err
	}
	if err := value.Field1.Serialize(serializer); err != nil {
		return err
...
func deserialize_tuple2_tuple3_ObjectID_SequenceNumber_ObjectDigest_Owner(deserializer serde.Deserializer) (struct {
	Field0 struct {
		Field0 ObjectID
		Field1 SequenceNumber
		Field2 ObjectDigest
...
func serialize_tuple3_ObjectID_SequenceNumber_ObjectDigest(value struct {
	Field0 ObjectID
	Field1 SequenceNumber
	Field2 ObjectDigest
}, serializer serde.Serializer) error {
...
func deserialize_tuple3_ObjectID_SequenceNumber_ObjectDigest(deserializer serde.Deserializer) (struct {
	Field0 ObjectID
	Field1 SequenceNumber
	Field2 ObjectDigest
}, error) {
	...
	if val, err := DeserializeObjectDigest(deserializer); err == nil {
		obj.Field2 = val
	} else {
		return obj, err
	}
...
func serialize_tuple3_SequenceNumber_vector_vector_u8_vector_ObjectID(value struct {
	Field0 SequenceNumber
	Field1 [][]uint8
	Field2 []ObjectID
}, serializer serde.Serializer) error {
	...
	if err := serialize_vector_vector_u8(value.Field1, serializer); err != nil {
		return err
	}
	if err := serialize_vector_ObjectID(value.Field2, serializer); err != nil {
		return err
	}
	return nil
}

func deserialize_tuple3_SequenceNumber_vector_vector_u8_vector_ObjectID(deserializer serde.Deserializer) (struct {
	Field0 SequenceNumber
	Field1 [][]uint8
	Field2 []ObjectID
}, error) {
...
func deserialize_vector_CallArg(deserializer serde.Deserializer) ([]CallArg, error) {
	...
	for i := range obj {
		if val, err := DeserializeCallArg(deserializer); err == nil {
			obj[i] = val
		} else {
			return nil, err
		}
...
func deserialize_vector_CheckpointCommitment(deserializer serde.Deserializer) ([]CheckpointCommitment, error) {
	...
	for i := range obj {
		if val, err := DeserializeCheckpointCommitment(deserializer); err == nil {
			obj[i] = val
		} else {
			return nil, err
		}
...
func deserialize_vector_Command(deserializer serde.Deserializer) ([]Command, error) {
	...
	for i := range obj {
		if val, err := DeserializeCommand(deserializer); err == nil {
			obj[i] = val
		} else {
			return nil, err
		}
...
func deserialize_vector_CompressedSignature(deserializer serde.Deserializer) ([]CompressedSignature, error) {
	...
	for i := range obj {
		if val, err := DeserializeCompressedSignature(deserializer); err == nil {
			obj[i] = val
		} else {
			return nil, err
		}
...
func deserialize_vector_ExecutionData(deserializer serde.Deserializer) ([]ExecutionData, error) {
	...
	for i := range obj {
		if val, err := DeserializeExecutionData(deserializer); err == nil {
			obj[i] = val
		} else {
			return nil, err
		}
...
func deserialize_vector_ExecutionDigests(deserializer serde.Deserializer) ([]ExecutionDigests, error) {
	...
	for i := range obj {
		if val, err := DeserializeExecutionDigests(deserializer); err == nil {
			obj[i] = val
		} else {
			return nil, err
		}
...
func deserialize_vector_GenericSignature(deserializer serde.Deserializer) ([]GenericSignature, error) {
	...
	for i := range obj {
		if val, err := DeserializeGenericSignature(deserializer); err == nil {
			obj[i] = val
		} else {
			return nil, err
		}
...
func deserialize_vector_GenesisObject(deserializer serde.Deserializer) ([]GenesisObject, error) {
	...
	for i := range obj {
		if val, err := DeserializeGenesisObject(deserializer); err == nil {
			obj[i] = val
		} else {
			return nil, err
		}
...
func deserialize_vector_MoveFieldLayout(deserializer serde.Deserializer) ([]MoveFieldLayout, error) {
	...
	for i := range obj {
		if val, err := DeserializeMoveFieldLayout(deserializer); err == nil {
			obj[i] = val
		} else {
			return nil, err
		}
...
func deserialize_vector_SenderSignedTransaction(deserializer serde.Deserializer) ([]SenderSignedTransaction, error) {
	...
	for i := range obj {
		if val, err := DeserializeSenderSignedTransaction(deserializer); err == nil {
			obj[i] = val
		} else {
			return nil, err
		}
...
func deserialize_vector_TypeOrigin(deserializer serde.Deserializer) ([]TypeOrigin, error) {
	...
	for i := range obj {
		if val, err := DeserializeTypeOrigin(deserializer); err == nil {
			obj[i] = val
		} else {
			return nil, err
		}
...
func serialize_vector_tuple2_AuthorityPublicKeyBytes_u64(value []struct {
	Field0 AuthorityPublicKeyBytes
	Field1 uint64
}, serializer serde.Serializer) error {
	if err := serializer.SerializeLen(uint64(len(value))); err != nil {
	...
	for _, item := range value {
		if err := serialize_tuple2_AuthorityPublicKeyBytes_u64(item, serializer); err != nil {
			return err
		}
	}
	return nil
...
func deserialize_vector_tuple2_AuthorityPublicKeyBytes_u64(deserializer serde.Deserializer) ([]struct {
	Field0 AuthorityPublicKeyBytes
	Field1 uint64
}, error) {
	length, err := deserializer.DeserializeLen()
	...
	for i := range obj {
		if val, err := deserialize_tuple2_AuthorityPublicKeyBytes_u64(deserializer); err == nil {
			obj[i] = val
		} else {
			return nil, err
		}
...
func serialize_vector_tuple2_ObjectID_SequenceNumber(value []struct {
	Field0 ObjectID
	Field1 SequenceNumber
}, serializer serde.Serializer) error {
	if err := serializer.SerializeLen(uint64(len(value))); err != nil {
	...
	for _, item := range value {
		if err := serialize_tuple2_ObjectID_SequenceNumber(item, serializer); err != nil {
			return err
		}
	}
	return nil
...
func deserialize_vector_tuple2_ObjectID_SequenceNumber(deserializer serde.Deserializer) ([]struct {
	Field0 ObjectID
	Field1 SequenceNumber
}, error) {
	length, err := deserializer.DeserializeLen()
	...
	for i := range obj {
		if val, err := deserialize_tuple2_ObjectID_SequenceNumber(deserializer); err == nil {
			obj[i] = val
		} else {
			return nil, err
		}
...
func serialize_vector_tuple2_str_u8(value []struct {
	Field0 string
	Field1 uint8
}, serializer serde.Serializer) error {
	if err := serializer.SerializeLen(uint64(len(value))); err != nil {
	...
	for _, item := range value {
		if err := serialize_tuple2_str_u8(item, serializer); err != nil {
			return err
		}
	}
	return nil
...
func deserialize_vector_tuple2_str_u8(deserializer serde.Deserializer) ([]struct {
	Field0 string
	Field1 uint8
}, error) {
	length, err := deserializer.DeserializeLen()
	...
	for i := range obj {
		if val, err := deserialize_tuple2_str_u8(deserializer); err == nil {
			obj[i] = val
		} else {
			return nil, err
		}
...
func serialize_vector_tuple2_tuple3_ObjectID_SequenceNumber_ObjectDigest_Owner(value []struct {
	Field0 struct {
		Field0 ObjectID
		Field1 SequenceNumber
		Field2 ObjectDigest
	...
	for _, item := range value {
		if err := serialize_tuple2_tuple3_ObjectID_SequenceNumber_ObjectDigest_Owner(item, serializer); err != nil {
			return err
		}
	}
	return nil
...
func deserialize_vector_tuple2_tuple3_ObjectID_SequenceNumber_ObjectDigest_Owner(deserializer serde.Deserializer) ([]struct {
	Field0 struct {
		Field0 ObjectID
		Field1 SequenceNumber
		Field2 ObjectDigest
...
func serialize_vector_tuple3_ObjectID_SequenceNumber_ObjectDigest(value []struct {
	Field0 ObjectID
	Field1 SequenceNumber
	Field2 ObjectDigest
}, serializer serde.Serializer) error {
	...
	for _, item := range value {
		if err := serialize_tuple3_ObjectID_SequenceNumber_ObjectDigest(item, serializer); err != nil {
			return err
		}
	}
	return nil
...
func deserialize_vector_tuple3_ObjectID_SequenceNumber_ObjectDigest(deserializer serde.Deserializer) ([]struct {
	Field0 ObjectID
	Field1 SequenceNumber
	Field2 ObjectDigest
}, error) {
...
func serialize_vector_tuple3_SequenceNumber_vector_vector_u8_vector_ObjectID(value []struct {
	Field0 SequenceNumber
	Field1 [][]uint8
	Field2 []ObjectID
}, serializer serde.Serializer) error {
	...
	for _, item := range value {
		if err := serialize_tuple3_SequenceNumber_vector_vector_u8_vector_ObjectID(item, serializer); err != nil {
			return err
		}
	}
	return nil
...
func deserialize_vector_tuple3_SequenceNumber_vector_vector_u8_vector_ObjectID(deserializer serde.Deserializer) ([]struct {
	Field0 SequenceNumber
	Field1 [][]uint8
	Field2 []ObjectID
}, error) {
	...
	for i := range obj {
		if val, err := deserialize_tuple3_SequenceNumber_vector_vector_u8_vector_ObjectID(deserializer); err == nil {
			obj[i] = val
		} else {
			return nil, err
		}
...
func serialize_vector_vector_GenericSignature(value [][]GenericSignature, serializer serde.Serializer) error {
	...
	for _, item := range value {
		if err := serialize_vector_GenericSignature(item, serializer); err != nil {
			return err
		}
	}
	return nil
...
func serialize_vector_vector_u8(value [][]uint8, serializer serde.Serializer) error {
	...
	for _, item := range value {
		if err := serialize_vector_u8(item, serializer); err != nil {
			return err
		}
	}
	return nil
