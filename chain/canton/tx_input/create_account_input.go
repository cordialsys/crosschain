...
type CreateAccountInput struct {
	...
	// * encoded as protobuf (despite JSON being used elsewhere)
	// * Used via Sighashes on the input?
	// * Unmarshals to interactive.PreparedTransaction on use
	// * really seems like blind signing
	// It's really unclear what the minimal inputs are and how transaction construction should occur.
	// It's done entirely by the server/node.
