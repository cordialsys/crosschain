...
type CreateAccountInput struct {
	...
	SetupProposalAcceptInput *CreateAccountAcceptInput `json:"setup_proposal_accept_input,omitempty"`
...
var _ xc.TxInputWithUnix = &CreateAccountInput{}
...
func (i *CreateAccountInput) SetUnix(unix int64) {
	if i == nil || i.SetupProposalAcceptInput == nil {
		return
	}
	i.SetupProposalAcceptInput.SetUnix(unix)
}
...
func (i *CreateAccountInput) VerifySignaturePayloads() error {
	...
	case CreateAccountStageAccept:
		if i.SetupProposalAcceptInput == nil {
			return fmt.Errorf("setup proposal accept input is nil")
		}
		if err := i.SetupProposalAcceptInput.Validate(); err != nil {
			return err
		}
		if i.SetupProposalAcceptInput.SubmissionID == "" {
			return fmt.Errorf("setup proposal accept submission ID is empty")
		}
		if i.SetupProposalAcceptInput.Hashing == interactive.HashingSchemeVersion_HASHING_SCHEME_VERSION_UNSPECIFIED {
			return fmt.Errorf("setup proposal accept hashing scheme is unspecified")
		}
	default:
...
func (i *CreateAccountInput) metadataBytes() ([]byte, error) {
	...
	if i.SetupProposalAcceptInput != nil {
		metadata.SetupProposalAcceptInput = i.SetupProposalAcceptInput.Clone()
	}
