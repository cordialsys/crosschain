...
func TestCreateAccountAcceptSighashes_UsesPreparedTransactionHash(t *testing.T) {
	...
	input := &tx_input.CreateAccountInput{
		...
		SetupProposalPreparedTransaction: preparedTx,
	}
...
func TestValidatePreparedTransactionHash_LiveCreateAccountAccept(t *testing.T) {
	...
	expectedHash, err := tx_input.ComputePreparedTransactionHash(input.SetupProposalPreparedTransaction)
	require.NoError(t, err)
	require.NoError(t, tx_input.ValidatePreparedTransactionHash(input.SetupProposalPreparedTransaction, expectedHash))
