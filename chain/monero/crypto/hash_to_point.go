...
func initHtpConstants() {
	...
	// SetBytes only fails on inputs != 32 bytes; uint64ToLE is always 32.
	_, _ = feA.SetBytes(uint64ToLE(486662))
	_, _ = feTwo.SetBytes(uint64ToLE(2))
